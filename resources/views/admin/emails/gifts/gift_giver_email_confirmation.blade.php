...
<!--[if !mso]><!-->
<div class="templateContainer" style="border:0 none #152C34;background-color:#F0FCFF;border-radius:0;display: table; width:600px">
...
<a href="https://sayitwithasock.com/?ims=ptyut&amp;utm_campaign=Gift+Notification&amp;utm_source=Ethel&amp;utm_medium=E-mail" target="_self" style="word-wrap:break-word;max-width:100%;color:#4C7CAD;font-weight:normal;text-decoration:none">
<img align="center" alt="Say it with a Sock" class="kmImage" src="https://d3k81ch9hvuctc.cloudfront.net/company/a5n8bz/images/34d71959-fca6-4d55-8a44-5b1a65566136.png" width="600" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;max-width:100%;padding-bottom:0;display:inline;vertical-align:top;font-size:12px;width:100%;max-width:1200px;" />
</a>
</td>
</tr>
</tbody>
...
<tbody>
<tr>
<td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:#425B74;font-family:"Lucida Grande", Lucida;font-size:20px;line-height:1.3;letter-spacing:normal;text-align:left;max-width:100%;word-wrap:break-word;padding-top:9px;padding-bottom:9px;padding-left:30px;padding-right:30px;'>
<style type="text/css">
@import url("https://fonts.googleapis.com/css?family=Muli:300,400,600,700");
</style>
<h1 style='color:#425B74;display:block;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif;font-size:40px;font-style:normal;font-weight:normal;line-height:110%;letter-spacing:normal;margin:0;margin-bottom:20px;text-align:left'><strong>Your Gift Email Is Scheduled</strong></h1>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:#425B74;font-family:"Lucida Grande", Lucida;font-size:20px;line-height:1.3;letter-spacing:normal;text-align:left;max-width:100%;word-wrap:break-word;font-size:16px;padding-right:30px;color:#425B74;padding-bottom:9px;text-align:left;font-weight:normal;padding-left:30px;padding-top:25px;line-height:2;'>
<p style='margin:0;padding-bottom:1em;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'>Hey {{ $giftOrder->billing_address_first_name }} a.k.a. best gift-giver of all time (B.G.G.O.A.T.)!</p>
<p style='margin:0;padding-bottom:1em;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'>This is a confirmation that you have schedule the following message to be sent to {{ $giftOrder->shipping_address_first_name }}</p>
<p style='margin:0;padding-bottom:0;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'>Email send date: {{ \Carbon\Carbon::parse($gift->email_send_date)->format('m-d-y') }}<br />
Email Address: {{ $gift->recipient_email }}<br />
Gift Message: {{ $gift->message }}</p>
</td>
</tr>
</tbody>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="kmDividerBlock" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;background-color:#2F5C89">
<tbody class="kmDividerBlockOuter">
<tr>
<td class="kmDividerBlockInner" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;padding-top:40px;">
<table class="kmDividerContent" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
...
<tbody class="kmTextBlockOuter">
<tr>
<td class="kmTextBlockInner" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;background-color:#2F5C89;">
<table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
<tbody>
<tr>
<td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:#425B74;font-family:"Lucida Grande", Lucida;font-size:20px;line-height:1.3;letter-spacing:normal;text-align:left;max-width:100%;word-wrap:break-word;padding-top:9px;padding-bottom:9px;padding-left:30px;color:#FFFFFF;padding-right:30px;'>
<p style='margin:0;padding-bottom:0;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif;text-align: center;'><strong><span style="color:#ffffff;">Everyone deserves a hug for their feet.<br />
For every friend you refer we’ll send you a free pair of socks!</span></strong></p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td valign="top" align="center" class="kmButtonBlockInner kmMobileStretch" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;min-width:60px;padding:9px 18px;padding-top:10px;padding-bottom:10px;background-color:#2F5C89;padding-left:35px;padding-right:35px;">
<table border="0" cellpadding="0" cellspacing="0" width="" class="kmButtonContentContainer" style="border-collapse:separate;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;border-top-left-radius:5px;border-top-right-radius:5px;border-bottom-right-radius:5px;border-bottom-left-radius:5px;background-color:#999;background-color:#F95957;border-radius:0px;">
<tbody>
<tr>
<td align="center" valign="middle" class="kmButtonContent" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:white;font-family:"Lucida Grande", Lucida;font-size:16px;padding:15px;padding-top:25px;padding-bottom:25px;font-size:24px;color:#FFFFFF;letter-spacing:0px;font-weight:lighter;padding-left:30px;padding-right:30px;font-family:"Lucida Grande", Lucida;'>
<a class="kmButton" title="" href="https://sayitwithasock.com/pages/refer?ims=upqoy&amp;utm_campaign=Gift+Notification&amp;utm_source=Ethel&amp;utm_medium=E-mail" target="_self" style='word-wrap:break-word;max-width:100%;font-weight:normal;line-height:100%;text-align:center;text-decoration:none;color:#4C7CAD;font-family:"Lucida Grande", Lucida;font-size:16px;text-decoration:none;color:#FFFFFF;letter-spacing:0px;font-size:24px;font-family:"Lucida Grande", Lucida;font-weight:lighter;padding-top:0;padding-bottom:0;'>REFER FRIENDS</a>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:#425B74;font-family:"Lucida Grande", Lucida;font-size:20px;line-height:1.3;letter-spacing:normal;text-align:left;max-width:100%;word-wrap:break-word;font-size:18px;font-weight:lighter;color:#425B74;padding-bottom:9px;text-align:left;padding-right:30px;padding-left:30px;padding-top:0px;line-height:2;font-family:"Lucida Grande", Lucida;'>
<p style='margin:0;padding-bottom:0;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'>If you have any questions, please reply to this email or contact us at hello@sayitwithasock.com</p>
</td>
</tr>
</tbody>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="kmDividerBlock" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;background-color:#3EBEE7">
<tbody class="kmDividerBlockOuter">
<tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="kmButtonBarBlock" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
<tbody class="kmButtonBarOuter">
<tr>
<td class="kmButtonBarInner" align="center" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;padding-top:0px;padding-bottom:0px;background-color:#3EBEE7;padding-left:0px;padding-right:0px;">
<table border="0" cellpadding="0" cellspacing="0" class="kmButtonBarContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
<tbody>
<tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="kmButtonBarContent" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;font-family:"Lucida Grande", Lucida'>
<tbody>
<tr>
<td align="center" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
...
<a href="https://www.facebook.com/sayitwithasock" target="_blank" style="word-wrap:break-word;max-width:100%;color:#4C7CAD;font-weight:normal;text-decoration:none"><img src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/subtleinverse/facebook_96.png" alt="Facebook" class="kmButtonBlockIcon" width="48" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;max-width:100%;width:48px; max-width:48px; display:block;" /></a>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td align="center" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;padding-right:10px;">
<a href="https://instagram.com/sayitwithasock" target="_blank" style="word-wrap:break-word;max-width:100%;color:#4C7CAD;font-weight:normal;text-decoration:none"><img src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/subtleinverse/instagram_96.png" alt="Instagram" class="kmButtonBlockIcon" width="48" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;max-width:100%;width:48px; max-width:48px; display:block;" /></a>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td align="center" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;">
<a href="https://twitter.com/sayitwithasock" target="_blank" style="word-wrap:break-word;max-width:100%;color:#4C7CAD;font-weight:normal;text-decoration:none"><img src="https://d3k81ch9hvuctc.cloudfront.net/assets/email/buttons/subtleinverse/twitter_96.png" alt="Twitter" class="kmButtonBlockIcon" width="48" style="border:0;height:auto;line-height:100%;outline:none;text-decoration:none;max-width:100%;width:48px; max-width:48px; display:block;" /></a>
</td>
</tr>
</tbody>
</table>
...
<tbody class="kmTextBlockOuter">
<tr>
<td class="kmTextBlockInner" valign="top" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;background-color:#3EBEE7;">
<table align="left" border="0" cellpadding="0" cellspacing="0" class="kmTextContentContainer" width="100%" style="border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed">
<tbody>
<tr>
<td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:#425B74;font-family:"Lucida Grande", Lucida;font-size:20px;line-height:1.3;letter-spacing:normal;text-align:left;max-width:100%;word-wrap:break-word;font-weight:normal;color:#FFFFFF;padding-bottom:9px;text-align:center;padding-right:18px;padding-left:18px;padding-top:20px;'>
<span style="font-size:12px;">SENT WITH <span style="color:#F95957;">♥</span> FROM THE SAY IT WITH A SOCK TEAM</span>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td class="kmTextContent" valign="top" style='border-collapse:collapse;mso-table-lspace:0;mso-table-rspace:0;table-layout:fixed;color:#425B74;font-family:"Lucida Grande", Lucida;font-size:20px;line-height:1.3;letter-spacing:normal;text-align:left;max-width:100%;word-wrap:break-word;font-size:10px;color:#FFFFFF;padding-bottom:10px;text-align:center;padding-right:9px;padding-left:9px;padding-top:10px;background-color:#3EBEE7;'>
<span style="font-size:10px;">No longer want to receive these emails? You can <a href="{% unsubscribe_link %}" style="word-wrap:break-word;max-width:100%;color:#4C7CAD;font-weight:normal;text-decoration:none">unsubscribe here</a>.<br />
Say it with a Sock LLC, 212 Marine St, Ste 100, Santa Monica California 90405</span>
</td>
</tr>
</tbody>
</table>

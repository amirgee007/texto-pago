...
<h1 style='color:#425B74;display:block;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif;font-size:40px;font-style:normal;font-weight:normal;line-height:110%;letter-spacing:normal;margin:0;margin-bottom:20px;text-align:left'><strong>Someone gave you a gift</strong></h1>
</td>
</tr>
</tbody>
</table>
...
<p style='margin:0;padding-bottom:1em;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'>Hey there {{ $giftOrder->shipping_address_first_name }},</p>
<p style='margin:0;padding-bottom:1em;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'><br />
Your wardrobe just got the upgrade of a lifetime...{{ $giftOrder->billing_address_name }} bought you a subscription to Say it with a Sock! Get ready to receive a fun new pair of the absolute freshest, comfiest socks every month.<br />
 <br />
Gift Message: {{ @$gift->message }}</p>
<p style='margin:0;padding-bottom:0;font-family:"Muli", "Lucida Grande", "Lucida Sans Unicode", Tahoma, Sans-Serif'> </p>
</td>
</tr>
</tbody>
</table>
